...
static const _ExampleSrv_Request_type_support_symbol_names_t _ExampleSrv_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lecture3_interfaces, srv, ExampleSrv_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lecture3_interfaces, srv, ExampleSrv_Request)),
  }
};
...
{
  return &::lecture3_interfaces::srv::rosidl_typesupport_cpp::ExampleSrv_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lecture3_interfaces, srv, ExampleSrv_Request)() {
  return get_message_type_support_handle<lecture3_interfaces::srv::ExampleSrv_Request>();
}
...
static const _ExampleSrv_Response_type_support_symbol_names_t _ExampleSrv_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lecture3_interfaces, srv, ExampleSrv_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lecture3_interfaces, srv, ExampleSrv_Response)),
  }
};
...
{
  return &::lecture3_interfaces::srv::rosidl_typesupport_cpp::ExampleSrv_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lecture3_interfaces, srv, ExampleSrv_Response)() {
  return get_message_type_support_handle<lecture3_interfaces::srv::ExampleSrv_Response>();
}
...
static const _ExampleSrv_type_support_symbol_names_t _ExampleSrv_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lecture3_interfaces, srv, ExampleSrv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lecture3_interfaces, srv, ExampleSrv)),
  }
};
...
{
  return &::lecture3_interfaces::srv::rosidl_typesupport_cpp::ExampleSrv_service_type_support_handle;
}
