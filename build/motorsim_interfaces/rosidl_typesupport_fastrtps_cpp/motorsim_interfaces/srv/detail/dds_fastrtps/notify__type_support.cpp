...
#include "motorsim_interfaces/srv/detail/notify__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const motorsim_interfaces::srv::Notify_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  motorsim_interfaces::srv::Notify_Request & ros_message)
{
  // Member: trig
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = motorsim_interfaces::srv::Notify_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const motorsim_interfaces::srv::Notify_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<motorsim_interfaces::srv::Notify_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_motorsim_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<motorsim_interfaces::srv::Notify_Request>()
{
  return &motorsim_interfaces::srv::typesupport_fastrtps_cpp::_Notify_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motorsim_interfaces, srv, Notify_Request)() {
  return &motorsim_interfaces::srv::typesupport_fastrtps_cpp::_Notify_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_motorsim_interfaces
cdr_serialize(
  const motorsim_interfaces::srv::Notify_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  motorsim_interfaces::srv::Notify_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = motorsim_interfaces::srv::Notify_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const motorsim_interfaces::srv::Notify_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<motorsim_interfaces::srv::Notify_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &motorsim_interfaces::srv::typesupport_fastrtps_cpp::_Notify_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motorsim_interfaces, srv, Notify_Response)() {
  return &motorsim_interfaces::srv::typesupport_fastrtps_cpp::_Notify_Response__handle;
}
...
{
  return &motorsim_interfaces::srv::typesupport_fastrtps_cpp::_Notify__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motorsim_interfaces, srv, Notify)() {
  return &motorsim_interfaces::srv::typesupport_fastrtps_cpp::_Notify__handle;
}
