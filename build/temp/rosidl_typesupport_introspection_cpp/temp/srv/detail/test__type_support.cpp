...
{
  new (message_memory) temp::srv::Test_Request(_init);
}

void Test_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<temp::srv::Test_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Test_Request_message_member_array[1] = {
  {
    ...
    offsetof(temp::srv::Test_Request, num),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Test_Request_message_members = {
  "temp::srv",  // message namespace
  "Test_Request",  // message name
  1,  // number of fields
  sizeof(temp::srv::Test_Request),
...
{
  return &::temp::srv::rosidl_typesupport_introspection_cpp::Test_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, temp, srv, Test_Request)() {
  return &::temp::srv::rosidl_typesupport_introspection_cpp::Test_Request_message_type_support_handle;
}
...
void Test_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) temp::srv::Test_Response(_init);
}

void Test_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<temp::srv::Test_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Test_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(temp::srv::Test_Response, structure_needs_at_least_one_member),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::temp::srv::rosidl_typesupport_introspection_cpp::Test_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, temp, srv, Test_Response)() {
  return &::temp::srv::rosidl_typesupport_introspection_cpp::Test_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Test_service_members = {
  "temp::srv",  // service namespace
  "Test",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<temp::srv::Test>()
...
get_service_type_support_handle<temp::srv::Test>()
{
  ...
  auto service_type_support =
    &::temp::srv::rosidl_typesupport_introspection_cpp::Test_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, temp, srv, Test)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<temp::srv::Test>();
}
