...
class Metaclass_Test_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('temp')
        except ImportError:
            import logging
            import traceback
...
class Test(metaclass=Metaclass_Test):
    from temp.srv._test import Test_Request as Request
    from temp.srv._test import Test_Response as Response
